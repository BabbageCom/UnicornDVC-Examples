...
class Unicorn(object):
	...
	def registerFunctions(self):
		...
		self.ActivateLicense=WINFUNCTYPE(c_wchar_p, POINTER(BOOL))(('Unicorn_ActivateLicense',self.lib))
		self.DeactivateLicense=WINFUNCTYPE(c_wchar_p, POINTER(BOOL))(('Unicorn_DeactivateLicense',self.lib))
